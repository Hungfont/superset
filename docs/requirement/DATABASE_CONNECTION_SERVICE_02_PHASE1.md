...
| **Dependency**    | **Priority** | **Phase** | **DB Tables** | **API / Route**                                                                                          |
| ----------------- | ------------ | --------- | ------------- | -------------------------------------------------------------------------------------------------------- |
| **✓ INDEPENDENT** | **P0**       | Phase 1   | dbs (read), tables, table_columns  | GET /api/v1/admin/databases/:id/schemas · GET /api/v1/admin/databases/:id/tables · GET /api/v1/admin/databases/:id/columns |
