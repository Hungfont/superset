...
type TaggedObject struct {
	ID         uint      `gorm:"primaryKey;autoIncrement" json:"id"`
	TagID      uint      `gorm:"column:tag_id;not null;index;uniqueIndex:idx_tag_obj,priority:1" json:"tag_id"`
	ObjectID   uint      `gorm:"column:object_id;not null;index;uniqueIndex:idx_tag_obj,priority:2" json:"object_id"`
