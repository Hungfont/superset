...
type ReportSchedule struct {
	...
	ChartID             *uint     `gorm:"column:chart_id;index" json:"chart_id"`
	DashboardID         *uint     `gorm:"column:dashboard_id;index" json:"dashboard_id"`
	DatabaseID          *uint     `gorm:"column:database_id;index" json:"database_id"`
...
type ReportRecipient struct {
	ID                  uint      `gorm:"primaryKey;autoIncrement" json:"id"`
	ReportScheduleID    uint      `gorm:"column:report_schedule_id;not null;index" json:"report_schedule_id"`
	Type                string    `gorm:"column:type;not null" json:"type"`
