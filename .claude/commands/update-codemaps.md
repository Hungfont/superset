# Update Codemaps
# /doc-update — Update Codemaps & Documentation
Invoke the **doc-updater** agent to scan the codebase and refresh all documentation.

## Execution
Launch the doc-updater agent and run `/update-codemaps` to regenerate `docs/CODEMAPS/*`:
